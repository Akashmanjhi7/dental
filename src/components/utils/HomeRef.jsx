    ...
    return (
        <div className='w-full min-h-screen pb-20 '>
            ...
            <div className='w-full h-auto flex items-center justify-center mt-32'>
                <img ref={imgRef} src="https://plus.unsplash.com/premium_photo-1663089993922-5d4601e1127b?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='w-full h-[80vh] object-cover'/>
            </div>
        </div>
    )
}
